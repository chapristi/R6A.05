    ...
    },
    {
        ...
        handler: async (request, h) => {
            ...
            try {
                ...
                return h.response({ response: 'suppression de l\'tilisateur avec succès' }).code(200);
            } catch (err) {
                return h.response({ response: 'Erreur lors de la suppression de l\'utilisateur' }).code(400);
            }
        }
    },
